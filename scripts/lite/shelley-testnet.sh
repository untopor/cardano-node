...
# This script it intended to be as simple as possible i.e execute and have a
...
for i in 1 2 3; do
  ...
  # Move genesis delegate keys generated in shelley genesis create command to it's
  ...
  mv "${data_dir}/genesis/delegate-keys/delegate$i.counter"   "${data_dir}/node-$i/counterFile"
  ...
  cardano-cli shelley node issue-op-cert \
      ...
      --operational-certificate-issue-counter-file "${data_dir}/node-$i/counterFile" \
